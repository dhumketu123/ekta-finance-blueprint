...
import { Activity, CheckCircle, XCircle, Clock, RefreshCw, Zap, AlertTriangle, BarChart3, Server } from "lucide-react";
  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        description={lang === "bn" ? "ডেলিভারি, ক্রন জব এবং সিস্টেম পরিসংখ্যান" : "Delivery, cron jobs & system metrics"}
        actions={
