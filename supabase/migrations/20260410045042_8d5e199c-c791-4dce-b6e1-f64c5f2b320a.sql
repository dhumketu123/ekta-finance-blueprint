...
BEGIN
  ...
  FOR v_rec IN
    SELECT reference_id FROM public.fn_claim_queue_batch(1000)
  LOOP
...
-- 8️⃣ PERFORMANCE INDEX
CREATE INDEX IF NOT EXISTS idx_queue_claim
ON public.ledger_guard_queue(processed_at, processing);
